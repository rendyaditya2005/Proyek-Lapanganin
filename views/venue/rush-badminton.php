  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
    ...
    <div>
      ...
      <p class="mt-2 text-gray-700">
        Rush Badminton menyediakan fasilitas lapangan yang nyaman 
        dengan pencahayaan yang baik di daerah Jember. Cocok untuk latihan 
        harian maupun turnamen kecil.
      </p>
