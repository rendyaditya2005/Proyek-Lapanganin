...
<section class="max-w-6xl mx-auto px-4 py-10">
  <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
    ...
    <!-- KIRI: FOTO + INFO -->
    <div>
      <img src="/assets/img/rush.jpg" class="w-full rounded-2xl mb-6" alt="">
      
      <h1 class="text-2xl font-bold">Rush Badminton</h1>
      <p class="mt-1 text-gray-600">⭐ 5.00 • Jember</p>

      <h2 class="font-semibold text-lg mt-6">Deskripsi</h2>
      <p class="mt-2 text-gray-700">
        Zona Futsal menawarkan lapangan dengan lantai yang bersih dan pencahayaan merata. 
        Area bermainnya cukup luas sehingga nyaman untuk latihan rutin maupun pertandingan persahabatan. 
        Tempat ini cocok untuk pemain pemula sampai tim komunitas yang butuh venue stabil dan mudah dijangkau di Jember.
      </p>
      ...
      <p class="mt-2 text-gray-700">
        Jl. Kalimantan Gg. 14, Jember, Jawa Timur.
      </p>
    </div>
